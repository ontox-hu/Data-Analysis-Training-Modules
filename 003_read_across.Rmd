...
A number of compounds experience really poor predictions and we loose 2253 compounds for which no similars can be found, based on the 0.75 cutoff for similarity.

```
# A tibble: 47 × 2   no_similars     n
         <dbl> <int> 1           0  2254
 2           1  1113
 3           2   702
 4           3   498
...
This makes a strong case for a different type of approach: see part "AI for Toxicity Prediction".
