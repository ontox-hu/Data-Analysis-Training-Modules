...
```{r, eval=FALSE}
library(rcdk)
DTXSID5020281 <- substances |>
  dplyr::filter(
    dtxsid == "DTXSID5020281"
  ) |> pluck("smiles")

mol <- parse.smiles(DTXSID5020281)[[1]]
...
Copy - paste the SMILES for 1-chloro-4-nitrobenzene into CDK DEDPICT and download the structure image.
...
target_substance <- substances |> 
  dplyr::filter(dtxsid == 'DTXSID5020281')
